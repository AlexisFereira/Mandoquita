...
Status: Superseded by completed light-only, token consolidation, and frontend remediation contracts.

The unchecked broad-plan items below are historical and must not be counted as active backlog.
