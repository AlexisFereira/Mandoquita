...
Superseded By: `../../light-only-theme-contract/specs/theme-system/spec.md`

The requirements below are retained only as historical traceability and are not active product requirements.
