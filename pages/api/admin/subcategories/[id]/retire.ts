...
import { retireSubcategory } from "../../../../../src/server/modules/subcategories";
import {
...
export async function handleAdminSubcategoryRetire(
  req: NextApiRequest,
  res: NextApiResponse,
) {
  ...
  try {
    ...
    const result = await prisma.$transaction(async (tx) => {
      ...
      const item = await retireSubcategory(
        txRepo,
        id,
        req.body,
...
export default handleAdminSubcategoryRetire;
